...
class TDViaParser
{
 ...
 public:
    ...
    NIError ParseREPL(Boolean IsDebugEnabled = false);
    ...
    void    ParseClump(VIClump* viClump, InstructionAllocator* cia, Boolean idIDE = false);
 ...
 public:
    static NIError StaticRepl(TypeManagerRef tm, SubString *replStream, Boolean IsDebugEnabled = false);
    static void FinalizeVILoad(VirtualInstrument* vi, EventLog* pLog, Boolean IsDebugEnabled = false);
    static void FinalizeModuleLoad(TypeManagerRef tm, EventLog* pLog, Boolean IsDebugEnabled = false);
